...
Write-Host ("  2. Or use AWS CLI: aws lambda update-function-code --function-name your-lambda-function-name --zip-file fileb://{0}" -f $OutputFile) -ForegroundColor White
Write-Host ""
